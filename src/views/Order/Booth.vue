  ...
  <div class="s-flex-col" style="height: 100%;">
    ...
    <div class="s-flex-auto" style="min-height: 0;">
      <el-table ref="tableRef" :data="tableData" border height="100%" show-overflow-tooltip
        ...
        <el-table-column v-if="columns_is_selected('订单编号')" prop="orderCode" label="订单编号" width="280" />
        ...
        <el-table-column v-if="columns_is_selected('展位数量')" prop="num" label="展位数量"  min-width="120"/>
