...
<template>
  <div class="contract-template">
    ...
    <p class="page-break">3、<b>协议签订后，如乙方在<input v-if="isEdit" class="input" v-model="contract.exitTime"><template>{{ contract.exitTime }}</template>后提出退展，则乙方无权要求退还展位费，甲方有权将展位另作安排。</b></p>
