...
<template>
  <div class="contract-template">
    ...
    <p><b>第三条 付款及退展</b></p>
    <p>1、乙方于协议约定时间内以电汇方式支付全部款项，并将签字盖章的协议原件或扫描件给甲方；逾期未履行协议，视为自动放弃所选服务。对于乙方减少展示面积的，甲方有权重新安排位置。</p>
    <p>2、乙方款项到达到甲方账户后，甲方向乙方开具正规增值税发票，按费用明细类别开据。</p>
    <p>3、<b>协议签订后，如乙方在2024-04-09后提出退展，则乙方无权要求退还展位费，甲方有权将展位另作安排。</b></p>
    <p>4、如乙方未在约定时间内向甲方缴纳全部相关费用，则视为乙方自动放弃所选展位，甲方有权将展位另作安排。</p>
    <p>5、指定收款账户信息（<b>必须公司付款，并在汇款时标明“2025北京站”</b>）</p>
    <p><b>户 名：北京智霖博雅展览有限公司</b></p>
    <p><b>开户行：招商银行北京阜外大街支行</b></p>
    <p><b>账 号：110909194610802</b></p>
    <p><b>第四条 权利与义务</b></p>
    <p>1、甲方保证按时取得展览会批件，保证活动的合法性。</p>
    <p>2、甲方将协助展馆做好秩序维护工作，并购买商业公众责任险，保障开展期间乙方以及来访者、参展人员的人身安全（以保险条款为准），保险范围以外的风险由来访者及参展人员自行承担。对于贵重、易损物品，乙方应自行妥善保管。</p>
    <p>
    ...
    <p>4、乙方必须保证其参展品牌符合《商业特许经营管理条例》和《广告法》的相关规定，一年之内不得出现相关投诉或者重大品牌负面舆论，否则甲方有权单方无条件解除本合同，不承担任何责任。</p>
    ...
    <p>2、乙方不履行或不完全履行本合同项下的任何义务，甲方有权书面通知其更正，乙方应在接到通知后十日内更正，逾期未更正的，甲方有权解除本合同并要求乙方赔偿损失。</p>
    <p>3、因乙方原因导致甲方与第三方发生纠纷的，乙方应当承担甲方因处理纠纷所发生的一切费用。</p>
    <p>4、乙方有以下行为的，甲方有权要求乙方停止不当行为，并可立即单方解除本合同，乙方应向甲方支付合同总金额29%的违约金，如造成甲方损失的，甲方有权要求乙方另行进行赔偿。</p>
    <p>4.1乙方违反《商业特许经营管理条例》和《广告法》；</p>
    <p>4.2乙方的行为损害到甲方的商业信誉的；</p>
    <p>4.3乙方的行为导致甲方与第三人发生纠纷的；</p>
    <p>4.4乙方的行为影响到展会秩序的；</p>
    <p>4.5乙方向甲方提供虚假材料、信息的；</p>
    <p>4.6乙方参展内容存在侵权的；</p>
    <p>4.7乙方对甲方员工存在商业贿赂、腐败行为的。</p>
    <p>5、如因乙方的过错，而导致甲方对第三方造成侵权的，全部责任由乙方承担。</p>
    <p>6、如因乙方违约导致本合同解除的，甲方已经收取的费用不予退还。</p>
    <p>7、违约方应当承担守约方因维权所支付的合理费用（包括但不限于：差旅费、公证费、鉴定费、审计费、律师费、诉讼费、仲裁费等合理开支）。</p>
    <p><b>第六条不可抗力约定</b></p>
    <p>如发生不可抗力致使甲乙任何一方不能履行、延迟履行或不能完全履行本协议项下规定的义务时，遭遇不可抗力的一方应立即以书面形式通知对方。不可抗力发生后，甲乙双方应通过友好协商尽快决定是否继续履行本协议。</p>
    <p><b>第七条其他约定</b></p>
    <p>
    ...
    <p>2、本协议自双方签字盖章后生效，一式贰份，甲乙双方各执壹份，电子版扫描件具有同等法律效力。</p>
    <p>3、本协议附件是本协议的组成部分，与本协议具有同等法律效力。</p>
    <p>
    ...
    <p>5、本合同未尽事宜甲乙双方共同协商解决，协商无法达成一致的，任何一方均有权向北京人民法院提出诉讼。</p>
